...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        @unless(($can_view_client === false) || (Auth::check()))
              <a class="pull-right" style="margin-right:2%;"href="/practitioner/viewclient/ {{ $client->id}}">
                 ...
                 <small> View {{ $client->fname }} {{ $client->sname }}'s profile </small>
              </a>
        @endunless    
        ...
        <ul class="nav nav-tabs">
            @if(Session::has('banner_message'))
                @if(Session::get('banner_message') === "Report successfully updated!")
                    ...
                    <li class="active"><a data-toggle="tab" href="#informationTab">Other Information</a></li>
                    <li><a data-toggle="tab" href="#sharingTab">Sharing</a></li>
                @else
                    <li><a data-toggle="tab" href="#home">Report</a></li>
                    <li><a data-toggle="tab" href="#informationTab">Other Information</a></li>
                    <li class="active"><a data-toggle="tab" href="#sharingTab">Sharing</a></li>
                @endif
    ...
    @if(Session::has('banner_message'))
        @if(Session::get('banner_message') === "Report successfully updated!")
            <div id="informationTab" class="tab-pane fade in active">
        @else
            <div id="informationTab" class="tab-pane fade">
        @endif
    @else
    ...
    @if(Session::has('banner_message'))
        ...
        @else
            <div id="sharingTab" class="tab-pane fade in active">
        @endif
                            ...
                            @else
                                ...
                                @foreach($shared_practitioners as $practitioner)
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="submit" class="btn btn-warning btn-xs">Remove</button></td>
                                    </tr>
                                    {!! Form::close() !!}
