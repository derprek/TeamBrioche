        ...
        <div class="col-lg-12">
            ...
            <div id="reportApp" class="tab-content">
                <div ng-controller="MyReportsController" id="home" class="tab-pane fade in active">
                    ...
                    <br>
                        <a ng-show="AllReports" id="addreport_btn" ng-cloak class="btn btn-success"
                           ...
                           role="button">
                           <i class="fa fa-file-o"></i> Create a new Report
                        </a>
                        <br>
                        ...
                        <br>
                            ...
                            <input ng-show="AllReports" type="text" placeholder="Search...." class="form-control" ng-model="searchReports.text">
                ...
                <div ng-controller="SharedReportsController" id="share" class="tab-pane fade">
                    ...
                    <dir-pagination-controls ng-if="SharedReports" template-url="/dirPagination.tpl.html" pagination-id="sharedReportsPagination"></dir-pagination-controls>
