...
<div id="reportApp">
    <div ng-controller="MyReportsController" class="container-fluid">
        ...
        <div ng-if="AllReports">
            <div ng-show="(AllReports| filter:search.text | filter:search.type).length == 0" class="emptyresults_container">
                <h3> No results found <i class="fa fa-meh-o"></i></h3>
            </div>
        </div>

        <dir-pagination-controls ng-if="AllReports" template-url="/dirPagination.tpl.html" pagination-id="ReportManagerPagination"></dir-pagination-controls>
